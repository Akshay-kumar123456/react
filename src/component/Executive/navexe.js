      ...
      <Navbar bg="light" style={{ height: 100 }} data-bs-theme="light">
        <Container>
          ...
          <Nav className="me-auto">
            <Nav.Link className='navitems' style={{ fontSize: '16px' }} onClick={() => navigate('/executive/home')} >Home</Nav.Link>
            <Nav.Link className='navitems' onClick={() => navigate('/executive/about')} style={{ fontSize: '16px' }}>About Us</Nav.Link>
            {localStorage.getItem('isLoggedIn') ?
              <React.Fragment>
                {/* <Nav.Link className='navitems' onClick={() => navigate('/executive/allairlines')} style={{ fontSize: '16px' }}>All Airlines</Nav.Link> */}
                <Nav.Link className='navitems' onClick={() => navigate('/executive/addairlines')} style={{ fontSize: '16px' }}>Add Airlines</Nav.Link>
              </React.Fragment> : ' '
            }
          </Nav>
          {
